...
<head>
    ...
    <meta name="description" content="DK INSTITUTES is one of the best IT training Institute in Pakistan that comes up with best IT trainings, jobs, Events and much more. DK INSTITUTES is the first priority of students who want to learn skills and earn money online">
    <meta name="keywords" content="Best IT Training Institute in pakistan, No 1 IT Training institute in pakistan,full stack development, MERN Stack, Web Development with PHP-Laravel or Python, HTML, CSS, SEO, Digital Marketing, Graphics, Corel Draw, Adobe Photoshop, Illustrator, CCNA, CCNP, MCSE" />
                        ...
                        <div class="container">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <h3>Our courses are built in partnership with technology leaders and are designed to
                                    meet industry demands.So what are you waiting for? Enroll now and get up to 50% exclusive discount</h3>
                    ...
                    <div class="caption">
                        <div class="container">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <h3>We are providing best techniques to learn future technologies in an effeciant way.
                                </h3>
                    ...
                    <div class="about-info">
                        ...
                        <figure>
                            ...
                            <figcaption>
                                ...
                                <p>Learn from industry experts who are passionated about teaching.</p>
                            </figcaption>
                        </figure>
                        ...
                        <figure>
                            ...
                            <figcaption>
                                <h3>Hands-on practise</h3>
                                <p>Our all courses are 100% practical and project based</p>
                            </figcaption>
                        </figure>
                    </div>
                </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="item">
                                <div class="courses-thumb">
                                    <div class="courses-top">
                                        <div class="courses-image">
                                            <img src="images/seo1.png" class="img-responsive" alt="">
                                        </div>
                        ...
                        {{-- <div class="col-md-4 col-sm-4">
                            <div class="item">
                                <div class="courses-thumb">
                                    <div class="courses-top">
                                        <div class="courses-image">
                                            <img src="images/ui ux.png" class="img-responsive" alt="">
                                        </div> --}}

                                        {{-- <div class="courses-detail">
                                            <h3><a href="{{ url('/forms') }}">UI/UX DESIGN</a></h3>
                                        ...
                                        <div class="courses-price">
                                            <a href="{{ url('/forms') }}"><span>RS <del> 28,000</del> 22,000
                                                </span></del></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="item">
                                <div class="courses-thumb">
                                    <div class="courses-top">
                                        <div class="courses-image">
                                            <img src="images/freelance.jpg" class="img-responsive" alt="">
                                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="contact-image">
                        <img src="images/dk6.jpg" class="img-responsive" alt="dk institute"
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="footer-info">
                        ...
                        <div class="copyright-text">
                            <p>Copyright &copy; 2022 DK INSTITUTES</p>
